...
module.exports = "* {font-family: \"Comic Sans MS\", \"Comic Sans\", cursive;}"
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.predict = function () {
        ...
        var body = JSON.stringify(this.sentence);
        this.http.post('http://multitask.ddnss.de:8080/predict', body, httpOptions).subscribe(function (res) {
            console.log(res);
            _this.sentence = "";
            _this.predictions.unshift(res);
        });
    };
